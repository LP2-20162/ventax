"""
Django settings for ventax_main project.
...
SECRET_KEY = '$+&hqeeyd_x9&9b(x%vec-e)u=-p$d6)1b##_s)1+0_fo_tz!z'
...
INSTALLED_APPS = [
    ...
    'ventax_service_apps.auths',
    'ventax_service_apps.auths_api',

    'ventax_service_apps.catalogo',
    'ventax_service_apps.catalogo_api',
...
WSGI_APPLICATION = 'ventax_main.wsgi.application'
